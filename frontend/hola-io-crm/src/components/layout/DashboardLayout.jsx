...
const NavigationItem = ({item,isActive,onClick,isCollapsed}) => {
  ...
  return <button
    ...
    className={`w-full flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200 group ${
      isActive
      ? "bg-green-50 text-green-800 shadow-sm shadow-green-50"
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform ${
        ...
        <div className="flex items-center h-16 border-b border-gray-200 px-6">
          ...
          <div className="h-8 w-8 bg-gradient-to-br from-green-800 to-green-600 rounded-lg flex items-center justify-center">
